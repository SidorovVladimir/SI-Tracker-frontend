...
export type GetProductionSitesQuery = { productionSites: Array<{ __typename: 'ProductionSite', id: string, name: string, cityId: string, companyId: string, createdAt: string, updatedAt: string }> };
