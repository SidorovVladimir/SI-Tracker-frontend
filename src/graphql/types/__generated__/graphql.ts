...
export type DeviceWithRelations = {
  ...
  name: Scalars['String']['output'];
  nomenclature: Maybe<Scalars['String']['output']>;
  productionSite: Scalars['String']['output'];
  receiptDate: Maybe<Scalars['String']['output']>;
  releaseDate: Maybe<Scalars['String']['output']>;
  serialNumber: Scalars['String']['output'];
...
export type GetDevicesWithRelationsListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDevicesWithRelationsListQuery = { devicesWithRelations: Array<{ __typename: 'DeviceWithRelations', id: string, name: string, model: string, serialNumber: string, releaseDate: string | null, grsiNumber: string | null, measurementRange: string | null, accuracy: string | null, inventoryNumber: string, receiptDate: string | null, manufacturer: string | null, verificationInterval: number | null, archived: boolean, nomenclature: string | null, status: string, city: string, company: string, productionSite: string }> };
