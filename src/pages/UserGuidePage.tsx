          ...
          <Table size="small">
            ...
            <TableBody>
              {[
                ...
                ['Свидетельство', 'Номер последнего свидетельства о поверке'],
    ...
    content: (
      <>
          ...
          <Table size="small">
            ...
            <TableBody>
              {[
                ...
                [
                  '🗑 Удалить',
                  'В карточке нет кнопки удаления — удаление доступно из формы редактирования',
                ],
                [
                  '🔗 Ссылка на Аршин',
        ...
        <ul>
          ...
          <li>
            <strong>Паспорт / Свидетельство</strong> — документы о поверке
          </li>
        </ul>
        <Typography variant="body2" paragraph>
      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            «не ГР» / «вне сферы государственного регулирования»)
          </li>
        </ul>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            👤 <strong>Закреплено вручную</strong> — сколько приборов вы
            назначили на этот месяц вручную
          </li>
        </ul>
        <Typography variant="body2" paragraph>
        ...
        <ul>
          ...
          <li>
            <strong>Ремонт</strong> — приборы, требующие ремонта
          </li>
          <li>
        ...
        <Alert severity="success" sx={{ mt: 2 }}>
          ...
          <Box component="ol" sx={{ mt: 1, mb: 0, pl: 2.5 }}>
            ...
            <li>
              Выберите вариант: <strong>«Создать новую партию»</strong> (введите
              номер) или <strong>«Добавить в существующий черновик»</strong>
            </li>
            <li>
              Нажмите <strong>«Сформировать партию»</strong>
            </li>
          </Box>
        </Alert>
        ...
        <ul>
          <li>
            Переходят в статус <strong>«Отправлено на поверку»</strong>
          </li>
          <li>
...
export default function UserGuidePage() {
  ...
  const scrollToSection = (id: string) => {
    setExpanded(id);
    setDrawerOpen(false);
    // Небольшая задержка, чтобы аккордеон успел раскрыться
    setTimeout(() => {
        ...
        >
          ...
          <Box sx={{ flexGrow: 1 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
              SI-Tracker — система учёта средств измерений, планирования
              поверок, инспекций и бюджетирования. Выберите раздел, чтобы
              узнать, как работать с системой.
            </Typography>
          </Box>
          {isMobile && (
            <Button
