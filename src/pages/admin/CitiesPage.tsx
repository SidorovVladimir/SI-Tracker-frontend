...
export default function CitiesPage() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      {isMobile ? (
        // 📱 МОБИЛЬНАЯ ВЕРСИЯ: Компактный однострочный список городов присутствия
        <Stack spacing={1}>
          {cities.map((c) => (
            <Paper
              key={c.id}
              ...
              sx={{
                ...
                display: 'flex',
                justifyContent: 'space-between',
                alignItems: 'center', // Выравниваем название города и кнопки по центру оси
                gap: 2,
              }}
            >
              {/* Наименование города присутствия холдинга */}
              <Typography
                variant="subtitle2"
                sx={{
                  ...
                  fontWeight: 700,
                  color: 'text.primary',
                  wordBreak: 'break-word', // Защита от излома верстки при длинных названиях городов
                  lineHeight: 1.3,
                }}
              >
                {cleanSpaces(c.name)}
